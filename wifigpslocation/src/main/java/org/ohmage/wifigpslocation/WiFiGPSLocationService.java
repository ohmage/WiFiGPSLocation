 ...
 */
public class WiFiGPSLocationService extends Service implements LocationListener {
    ...
    private static final String WIFISCAN_ALARM_ACTION = "wifiscan_alarm";
    private static final String CLEANUP_ALARM_ACTION = "cleanup_alarm";
    private static final String NETSCAN_ALARM_ACTION = "netscan_alarm";
    ...
    private static final String CACHED_PROVIDER = "WiFiGPSLocation:Cached";
    ...
    */
    ...
    private final IWiFiGPSLocationService.Stub mBinder = new IWiFiGPSLocationService.Stub() {
        ...
        public static final String FAKE_PROVIDER = WiFiGPSLocationService.FAKE_PROVIDER;
        public static final String WIFIGPS_PROVIDER = WiFiGPSLocationService.WIFIGPS_PROVIDER;
        public static final String APPROX_PROVIDER = WiFiGPSLocationService.APPROX_PROVIDER;
        public static final String NET_PROVIDER = WiFiGPSLocationService.NET_PROVIDER;
        ...
        public synchronized Location getLocation() {
            ...
            if (mLastKnownLoc != null) {
                Log.v(TAG, "Reporting " + mLastKnownLoc.getProvider() + " to client.");
                return mLastKnownLoc;
            } else {
                Log.v(TAG, "Reporting " + mFakeLocation.getProvider() + " to client.");
        ...
        public String getWiFiScan() {
            ...
            if (mScanResults != null) {
                try {
                    ...
                    */
                    scanResult.put("time", mWifiScanTime.getTimeInMillis());
                    scanResult.put("timezone", DateTimeZone.getDefault().getID());
         ...
         */
        @Override
        public void registerCallback(String callerName, ILocationChangedCallback callback) {
            if ((callerName == null) || (callback == null)) {
                return;
            }

            if (!mClientsTable.containsKey(callerName)) {
                mClientsTable.put(callerName, DEFAULT_GPS_SCANNING_INTERVAL);
            }
         ...
         */
        @Override
        public void unregisterCallback(String callerName, ILocationChangedCallback callback) {
            if (callerName == null) {
                return;
            }
    ...
    protected void showWiFiDisabledNotification() {
        ...
        note.setLatestEventInfo(this, getString(R.string.no_wifi_title),
    ...
    */
    ...
    public IBinder onBind(Intent intent) {
        if (IWiFiGPSLocationService.class.getName().equals(intent.getAction())) {
            return mBinder;
        }
